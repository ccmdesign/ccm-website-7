...
Complete directory structure for the ccm-website project:
...
### `/components`
Vue components following ccm naming convention, auto-imported by Nuxt.

### `/content` 
Nuxt Content markdown files that become routes automatically.

### `/public/css`
CSS architecture using layer methodology with modular organization.

### `/composables`
Vue composables for content processing and business logic.

### `/docs`
Project documentation including sharded architecture and PRD documents.